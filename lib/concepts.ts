...
const conceptStudyBlockOverrides: Record<string, ConceptStudyBlock[]> = {
  "modeling-normalization": [
    ...
    },
    {
      type: "table",
      title: "정규화 예시: 수강내역",
      headers: ["정규형", "분해 전 모습", "문제점", "분해 후 모습"],
      rows: [
        ["1NF", "고객(고객번호, 고객명, 연락처1, 연락처2)", "연락처가 반복 컬럼으로 늘어난다.", "고객(고객번호, 고객명), 고객연락처(고객번호, 연락처순번, 연락처)"],
        ["2NF", "수강강좌(학생번호, 강좌이름, 강의실, 성적), PK=(학생번호, 강좌이름)", "강의실은 복합키 전체가 아니라 강좌이름만으로 결정된다.", "수강(학생번호, 강좌이름, 성적), 강좌(강좌이름, 강의실)"],
        ["3NF", "결제내역(학생번호, 강좌이름, 수강료), 학생번호 -> 강좌이름 -> 수강료", "수강료는 학생번호가 아니라 강좌이름을 통해 이행적으로 결정된다.", "수강신청(학생번호, 강좌이름), 강좌금액(강좌이름, 수강료)"]
      ]
    },
    {
      type: "table",
      title: "제1정규형 예시: 반복 컬럼 제거",
      headers: ["고객번호", "고객명", "연락처1", "연락처2"],
      rows: [
        ["C001", "김민수", "010-1111-1111", "02-111-1111"],
        ["C002", "이지은", "010-2222-2222", ""]
      ]
    },
    {
      type: "table",
      title: "제1정규형 분해 후: 고객연락처",
      headers: ["고객번호", "연락처순번", "연락처"],
      rows: [
        ["C001", "1", "010-1111-1111"],
        ["C001", "2", "02-111-1111"],
        ["C002", "1", "010-2222-2222"]
      ]
    },
    {
      type: "table",
      title: "제2정규형 예시: 분해 전 수강강좌",
      headers: ["학생번호", "강좌이름", "강의실", "성적"],
      rows: [
    ...
    },
    {
      ...
      steps: [
        "기본키는 (학생번호, 강좌이름)이다.",
        "(학생번호, 강좌이름) 전체가 성적을 결정한다.",
        "강좌이름 하나만으로 강의실을 결정한다.",
        "따라서 강의실은 복합키의 일부에만 종속되어 제2정규형 위반이다."
      ]
    },
    {
      type: "table",
      title: "제2정규형 분해 후: 수강",
      headers: ["학생번호", "강좌이름", "성적"],
      rows: [
        ["501", "데이터베이스", "3.5"],
        ["401", "데이터베이스", "4.0"],
        ["402", "스포츠경영학", "3.5"],
    ...
    {
      type: "table",
      title: "제3정규형 예시: 분해 전 결제내역",
      headers: ["학생번호", "강좌이름", "수강료"],
      rows: [
        ["501", "데이터베이스", "20000"],
        ["401", "데이터베이스", "20000"],
        ["402", "스포츠경영학", "15000"],
    ...
    },
    {
      ...
      title: "이행 함수 종속 흐름",
      steps: [
        "학생번호가 강좌이름을 결정한다고 가정한다.",
        "강좌이름은 수강료를 결정한다.",
        "그러면 학생번호가 강좌이름을 거쳐 수강료를 결정한다.",
        "수강료를 바꾸려면 같은 강좌를 듣는 모든 행을 함께 바꿔야 하므로 제3정규형 위반이다."
      ]
    },
    {
      type: "table",
      title: "제3정규형 분해 후: 수강신청",
      headers: ["학생번호", "강좌이름"],
      rows: [
        ["501", "데이터베이스"],
        ["401", "데이터베이스"],
