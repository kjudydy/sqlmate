...
- Added source analysis for the attached SQLP 3과목 PDF.
- Added current-state audit for the existing SQLMate app.
...
- Deployed initial SQLMate prototype with Supabase Google login, dashboard, local problem bank, concepts, SQL lab, wrong notes, and personal notes.
